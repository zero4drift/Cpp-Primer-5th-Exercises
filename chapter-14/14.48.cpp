// See Employee.h.
// class type Employee shoudl define its bool conversion operator, for one Employee object may has no content if it is default constructed(or its data member 'name' is an empty string), and such object used as condition should be converted to bool;
